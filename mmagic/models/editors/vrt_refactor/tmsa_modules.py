...
from mmagic.models.basicsr_utils.vidt_proc import window_partition, window_reverse, get_window_size, compute_mask

class TMSA(nn.Module): # Temporal Mutual Self Attention

    def __init__(self, n_channels, n_heads,
                 window_size=(6, 8, 8),
                 shift_size=(0, 0, 0), mlp_ratio=2.,    # Ratio of mlp hidden n_channels to embedding n_channels.
    ...
    def _forward(self, x, attn_mask):
        ...
        attn_windows = self.attention(x_windows, mask=attn_mask)  # B*nW, Wd*Wh*Ww, C
